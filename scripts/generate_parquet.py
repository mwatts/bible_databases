...
def main():
    ...
    languages = [
        ...
        if os.path.isdir(os.path.join(source_directory, d)) and d != "extras"
    ]
    print("Choose your language:")
    language = list_options(
        languages,
    ...
    translations = [
        d for d in os.listdir(os.path.join(source_directory, language))
        if os.path.isdir(os.path.join(source_directory, language, d))
    ]
    print(f"Choose your translation for {language}:")
    translation = list_options(
        translations,
